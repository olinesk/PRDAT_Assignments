...
# 1 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
...
# 14 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
...
# 152 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                 ...
                 : 'gentype__startMain));
# 161 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 25 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               _1                
                   )
# 25 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : Absyn.expr));
# 172 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> string in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 29 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               Var _1            
                   )
# 29 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
# 183 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> int in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 30 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               CstI _1           
                   )
# 30 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
# 194 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _2 = parseState.GetInput(2) :?> int in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 31 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               CstI (- _2)       
                   )
# 31 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
# 205 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _2 = parseState.GetInput(2) :?> 'gentype_Expr in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 32 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               _2                
                   )
# 32 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
# 216 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 33 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               Let(_2, _4, _6)   
                   )
# 33 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
# 229 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 34 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               Prim("*", _1, _3) 
                   )
# 34 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
# 241 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
            let _3 = parseState.GetInput(3) :?> 'gentype_Expr in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 35 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               Prim("+", _1, _3) 
                   )
# 35 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
# 253 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
            let _3 = parseState.GetInput(3) :?> 'gentype_Expr in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 36 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                                                               Prim("-", _1, _3) 
                   )
# 36 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fsy"
                 : 'gentype_Expr));
|]
# 266 "../BPRD-03-OKRE-PEKP/Assignment3/Expr/ExprPar.fs"
